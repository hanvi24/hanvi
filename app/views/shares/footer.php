        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <li><a href="/Product/cart" class="text-dark">Giỏ hàng</a></li>
                </ul>
            </div>
            <div class="col-lg-3 col-md-6 mb-4">
                <h5 class="text-uppercase">Kết nối với chúng tôi</h5>
                <a href="https://www.facebook.com/LAPTOP.VITINH.DIENTU" class="text-dark mr-3"><i class="fab fa-facebook-f"></i></a>
                <a href="https://www.tiktok.com/@linhkiensgtool" class="text-dark mr-3"><i class="fab fa-tiktok"></i></a>
