    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto"> 
                ...
                <li class="nav-item">
                    <?php
                    require_once 'app/helpers/SessionHelper.php'; // Đảm bảo file được include
                    if(SessionHelper::isLoggedIn()) {
                        echo "<a class='nav-link text-white'>Xin chào, " . $_SESSION['username'] . "</a>";
                    } else {
                        echo "<a class='nav-link text-white' href='/account/login'>Đăng nhập</a>";
                    }
                    ?>
                </li>
                ...
                <li class="nav-item">
                    <?php
                    if(SessionHelper::isLoggedIn()) {
                        echo "<a class='nav-link text-white' href='/account/logout'>Đăng xuất</a>";
                    }
                    ?>
                </li>
            </ul>
